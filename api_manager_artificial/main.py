...
db_backup_path = os.path.abspath(os.path.join(parent_dir, "log_db_updater_artificial", "db_backup.db"))
...
tables: List[str] = ["ByBit_futureperp_BTC_USDT_1m_FLAS", "ByBit_futureperp_ETH_USDT_1m_FLAS"]  # populate this with your table names
